...
const fullText1 = splitLines("Gửi Cục Dàng Của Anh ^.^", 5);
const fullText2 = splitLines("CHÚC MỪNG VALENTINE ĐẦU TIÊN MÌNH ĐƯỢC YÊU THƯƠNG CÙNG NHAU ❤️ ", 3);
const fullText3 = splitLines("Từ nay về sau, trên con đường em đi sẽ không còn những bước chân lẻ loi nữa.", 8);
const fullText4 = splitLines("Dẫu ngoài kia có làm tổn thương em. Mong em đừng giấu trong lòng, anh vẫn ở đây yêu thương và lắng nghe em. Đừng buông tay nhau ra nha, vì hành trình của mình chỉ trọn vẹn khi có anh và em thôi ❤️", 8);
